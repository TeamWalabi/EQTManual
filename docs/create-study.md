...
Every new study requires metadata for findability. A study’s metadata includes all the necessary details about the study such as study duration, research question, study type, and objective. To create a new study, click the plus icon ‘’ on the left (see arrow, Figure 2). A dialog will appear that enables you to enter the required metadata. Please complete only the fields that are relevant for your study. Upon completion, the user is automatically assigned the role of study owner.
...
**Figure 2. Create new study**

![Figure 2. Create new study](assets/image49.png)



## 3.2. Provide study sharing details
...
Table 1. Study roles and their functions





**Figure 3. Select user and role for study**

![Figure 3. Select user and role for study](assets/image5.png)
...
## 3.3. Find study and access details
...
**Figure 4. Search study page**

![Figure 4. Search study page](assets/image51.png)
